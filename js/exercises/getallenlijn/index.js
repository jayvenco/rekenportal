// exercises/getallenlijn/index.js
// -----------------------------------------------------------------------------
// Startpunt van de getallenlijn-module. Regelt de overgang tussen het
...
import { icoonGetallenlijn } from "../../utils/iconen.js";
...
export const getallenlijnOefening = {
  id: "getallenlijn",
  titel: "Getallenlijn",
  omschrijving: "Oefen met getallen op de lijn: zoeken, plaatsen en sprongen maken.",
  icoonSvg: icoonGetallenlijn(),
  kleurthema: "#4f8fe8",
  mount,
};
