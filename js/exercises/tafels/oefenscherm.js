// exercises/tafels/oefenscherm.js
// -----------------------------------------------------------------------------
// Het daadwerkelijke oefenscherm van de tafels: toont keersommen één voor één,
  ...
  function toonOpgave() {
    ...
    if (instellingen.moeilijkheid === "makkelijk") {
      opruimHuidigeInvoer = bouwMeerkeuzeInvoer(
        ...
        genereerFouteKeerAntwoorden(huidigeOpgave.antwoordGoed, huidigeOpgave.meta.tafel)
      );
    } else {
