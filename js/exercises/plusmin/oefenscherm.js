// exercises/plusmin/oefenscherm.js
// -----------------------------------------------------------------------------
// Het daadwerkelijke oefenscherm van plus-en-min: toont sommen één voor één,
// verwerkt antwoorden via een groot cijfertoetsenbord, geeft feedback en
// stuurt de raket-animatie aan.
// -----------------------------------------------------------------------------
...
const EXERCISE_ID = "plusmin";

/**
 * Start de oefensessie.
 * @param {HTMLElement} container
 * @param {Object} instellingen - { min, max, bewerking, aantalOpgaven }
