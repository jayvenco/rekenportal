// exercises/grote-getallen/instelscherm.js
// -----------------------------------------------------------------------------
// Instelscherm voor grote getallen: vraagtype(s) kiezen + aantal opgaven.
// -----------------------------------------------------------------------------

import { getInstellingen, saveInstellingen } from "../../storage.js";

const ALLE_TYPES = [
  { id: "naar-getal", label: "Schrijf als getal", voorbeeld: "3 miljoen = 3000000" },
  { id: "plus-groot", label: "Optellen met grote getallen", voorbeeld: "2 miljoen + 3 miljoen" },
  { id: "hoeveel-nullen", label: "Hoeveel nullen?", voorbeeld: "Hoeveel nullen heeft 1 miljoen?" },
];
 ...
 * @param {Function} opStarten
 */
export async function bouwInstelscherm(container, opStarten) {
  const opgeslagen = (await getInstellingen("grote-getallen")) || {};
  const instellingen = {
  ...
  titel.textContent = "Oefen grote getallen";
  kaart.appendChild(titel);

  const uitleg = document.createElement("p");
  uitleg.textContent = "Oefen met miljoenen en miljarden: lezen, optellen en nullen tellen.";
  ...
  startKnop.addEventListener("click", async () => {
    ...
    await saveInstellingen("grote-getallen", instellingen);
