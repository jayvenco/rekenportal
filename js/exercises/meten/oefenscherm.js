// exercises/meten/oefenscherm.js
// -----------------------------------------------------------------------------
// Het daadwerkelijke oefenscherm van de meten-module: toont meet-opgaven één
// voor één, verwerkt antwoorden, geeft feedback en stuurt de raket-animatie aan.
// -----------------------------------------------------------------------------
  ...
  function toonOpgave() {
    ...
    if (instellingen.moeilijkheid === "makkelijk") {
      opruimHuidigeInvoer = bouwMeerkeuzeInvoer(
        ...
        genereerFouteKeerAntwoorden(huidigeOpgave.antwoordGoed, huidigeOpgave.antwoordGoed)
      );
    } else {
